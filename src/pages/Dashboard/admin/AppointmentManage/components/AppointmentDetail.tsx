      ...
      <div className='space-y-4'>
        ...
        <div className='grid gap-4 p-4 border rounded-lg'>
          <div className='grid grid-cols-2 gap-4'>
            <div>
              <p className='font-medium text-gray-500'>Bác sĩ</p>
              <p>
            ...
            <div>
              <p className='font-medium text-gray-500'>Bệnh nhân</p>
              <p>
          ...
          <div className='grid grid-cols-2 gap-4'>
            ...
            <div>
              <p className='font-medium text-gray-500'>Phí khám</p>
          ...
          <div className='grid grid-cols-2 gap-4'>
            <div>
              <p className='font-medium text-gray-500'>Ngày khám</p>
          ...
          <div className='grid grid-cols-2 gap-4'>
            <div>
              <p className='font-medium text-gray-500'>Hình thức khám</p>
